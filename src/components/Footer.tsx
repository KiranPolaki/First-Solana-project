  ...
  return (
    <footer className="bg-default-950/40 backdrop-blur-3xla">
      <div className="container py-20 lg:px-20">
        <div className="grid grid-col-2 gap-10 lg:grid-cols-12 lg:gap-16">
          ...
          <div className="col-span-2 lg:col-span-6">
            <div className="bg-primary/20 rounded-xl">
              <div className="p-10">
                ...
                <p className="text-default-200 mb-6 test-base font-medium">
                  Signup and recive the latest tips
                </p>
                ...
                <div>
                  ...
                  <ul className="flex flex-wrap items-center gap-1">
                    {[<TiSocialLinkedin />, <TiSocialTwitter />].map(
                      (social, i) => (
                        <li key={i}>
                          <a
                            href="#"
