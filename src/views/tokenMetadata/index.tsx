...
export const TokenMetadata: FC<CreateViewProps> = ({
  ...
  const getMetadata = useCallback(
    async (form) => {
      ...
      try {
        ...
        notify({
          type: "error",
          message: "Token meta data failed fetched token metadata",
        });
        setIsLoading(false);
      }
    },
            ...
            {!loaded ? (
              <div className="lg:ps-0 flex h-full flex-col p-10">
                ...
                <div className="my-auto pb-6 text-center">
                  ...
                  {/* <div className="flex items-center justify-center">
                    <img src={"assets/logout.svg"} alt="" className="h-40" />
                  </div> */}
                  <div className="mt-5 w-full text-center">
                    <p className="text-white text-base font-medium leading-6 bg-red-500"></p>
                    <InputView
                      name={"Token Address"}
                      placeholder={"address"}
                    ...
                    <div className="mb-6 text-center">
                      ...
                      >
                        <span className="fw-bold">Get Meta Data</span>
                      </button>
                    </div>
                    <CloseModal />
                  </div>
              ...
              <div className="lg:ps-0 flex h-full flex-col p-10">
                ...
                <div className="my-auto pb-6 text-center">
                  ...
                  <div className="mt-5 w-full text-center">
                    <p className="text-white text-base font-medium leading-6"></p>
                    <InputView
                      name={"Token Address"}
